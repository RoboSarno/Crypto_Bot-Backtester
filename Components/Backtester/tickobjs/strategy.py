...
class Strategy:
    ...
    def add_db_elements(self, strat):
        """_summary_
        ...
        if strat == 1:
            self.master_df = self.master_df.rename(columns={
                                            'psarl_0.02_0.2': 'psarl', 
                                            'psars_0.02_0.2': 'psars', 
        ...
        if strat == 2:
            self.master_df = self.master_df.rename(columns={
                                            'supert_14_3.0': 'supert', 
                                            'supertd_14_3.0': 'supertd', 
                                            'supertl_14_3.0': 'supertl', 
                                            'superts_14_3.0': 'superts',
                                            }
                                )
